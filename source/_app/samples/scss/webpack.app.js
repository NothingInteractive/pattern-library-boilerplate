...
module.exports = env => {
  ...
  const appNamespace = plConfig.app.namespace ? `$ns:${plConfig.app.namespace};` : ``;
  const app = {
    entry: {
      ...
      rules: [
        {
          ...
          use: [
            {
              loader: ifDevelopment('style-loader', MiniCssExtractPlugin.loader)
            },
            {
              loader: 'css-loader',
              options: {
            ...
            },
            {
              ...
              options: {
                precision: 3,
                sourceMap: ifDevelopment(),
                outputStyle: ifProduction('compressed', 'expanded'),
                data: appNamespace
              }
            },
            {
